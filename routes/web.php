...
Route::get('docs', DocumentationRootController::class)->name('documentation.root');
Route::get('docs/{page}', DocumentationRedirectController::class)->name('documentation.redirect');
